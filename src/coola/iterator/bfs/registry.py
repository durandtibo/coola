...
class ChildFinderRegistry:
    ...
    Example:
        ...
        >>> registry = ChildFinderRegistry({list: IterableIterator()})
        >>> registry
        ChildFinderRegistry(
    ...
    def __init__(self, registry: dict[type, BaseChildFinder[Any]] | None = None) -> None:
        ...
        self._default_iterator: BaseChildFinder[Any] = DefaultChildFinder()
        self._iterator_cache: dict[type, BaseChildFinder[Any]] = {}
    ...
    def find_child_finder(self, data_type: type) -> BaseChildFinder[Any]:
        ...
        if data_type not in self._iterator_cache:
            self._iterator_cache[data_type] = self._find_child_finder_uncached(data_type)
