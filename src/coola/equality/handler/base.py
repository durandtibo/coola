...
class BaseEqualityHandler(ABC):
    ...
    def equal(self, other: object) -> bool:
        ...
        This method provides a default implementation that checks if both
        handlers are of the same type and have equal next handlers. Child
        classes can override this method if they need custom equality logic.
