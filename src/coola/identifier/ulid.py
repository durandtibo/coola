...
Unlike ``generate_stable_uuid`` and ``generate_content_id``, a ULID is
not derived from data content: two calls with the same input produce
different values. Use it when what you need is a unique,
