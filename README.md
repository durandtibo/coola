...
<p align="center">
    ...
    <a href="[https://pepy.tech/project/coola](https://scorecard.dev/viewer/?uri=github.com/durandtibo/coola)">
        <img  alt="OpenSSF Scorecard" src="[https://static.pepy.tech/badge/coola/month](https://api.scorecard.dev/projects/github.com/durandtibo/coola/badge)">
    </a>
    <br/>
</p>
...
| `coola`  | `jax`<sup>*</sup> | `numpy`<sup>*</sup> | `packaging`<sup>*</sup> | `pandas`<sup>*</sup> | `polars`<sup>*</sup> | `pyarrow`<sup>*</sup> | `pydantic`<sup>*</sup> | `torch`<sup>*</sup> | `xarray`<sup>*</sup> | `python` |
|----------|-------------------|---------------------|-------------------------|----------------------|----------------------|-----------------------|------------------------|---------------------|----------------------|----------|
